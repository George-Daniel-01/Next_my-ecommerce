...
// import { toggleSidebar } from "@/app/store/slices/popupSlice"; // Add this if needed
  ...
  return (
    <>
      ...
      <div
        ...
        // BUG FIX: Either import toggleSidebar or use toggleAuthPopup
        ...
        <div className="p-6">
          ...
          <div className="space-y-4 mb-8">
            ...
            <button
              ...
              className="flex justify-center items-center space-x-3 p-3 rounded-lg glass-card hover:glow-on-hover animate-smooth group w-full disabled:opacity-70"
            >
              {isUpdatingProfile ? (
                <>
