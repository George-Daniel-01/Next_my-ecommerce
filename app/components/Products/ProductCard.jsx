...
const ProductCard = ({ product }) => {
  ...
  // ✅ ADDED: Helper function to check if product is new (within 30 days)
  ...
  // ✅ ADDED: Helper function to check if product is top rated
  const isTopRated = (product) => {
    ...
    >
      <div className="relative overflow-hidden rounded-lg mb-4">
        ...
        <div className="absolute top-3 left-3 flex flex-col space-y-2">
          {/* ✅ FIXED: Use helper function with proper field name handling */}
