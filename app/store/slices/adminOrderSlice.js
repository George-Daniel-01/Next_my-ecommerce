...
export const fetchAllOrders = createAsyncThunk("adminOrder/fetchAll", async (_, thunkAPI) => {
  try {
...
export const updateOrderStatus = createAsyncThunk("adminOrder/updateStatus", async ({ orderId, status }, thunkAPI) => {
  try {
...
export const deleteOrder = createAsyncThunk("adminOrder/delete", async (orderId, thunkAPI) => {
  try {
