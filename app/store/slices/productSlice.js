...
const productSlice = createSlice({
  ...
  initialState: {
    ...
    productReviews: [],
    totalProducts: 0,
    // ✅ FIX: Start as true so the spinner shows immediately on first render
    // before the API call completes. Without this, loading=false + product=null
    // causes "Product Not Found" to flash before data arrives.
    loading: true,
  ...
  reducers: {
    // ✅ FIX: Call this when entering a product page to clear stale data
    // and reset loading so the spinner always shows while fetching
        ...
        if (existingReviewIndex !== -1) {
          ...
          const reviewToAdd = {
            ...
            reviewer: newReview.reviewer || {
              ...
              name: newReview.user_name || "Anonymous",
              avatar: newReview.user_avatar || null,
            },
          };
          state.productReviews = [reviewToAdd, ...state.productReviews];
        }
      })
