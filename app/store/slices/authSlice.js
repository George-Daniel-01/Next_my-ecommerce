...
export const updateAdminPassword = updatePassword;
...
const authSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(register.pending, (state) => { state.isLoggingIn = true; })
      .addCase(register.fulfilled, (state, action) => { state.isLoggingIn = false; state.user = action.payload; state.isAuthenticated = true; })
      .addCase(register.rejected, (state) => { state.isLoggingIn = false; })
